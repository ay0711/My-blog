...
import { FiBell, FiHeart, FiMessageCircle, FiRepeat, FiUserPlus, FiAtSign, FiSettings, FiTrash2 } from 'react-icons/fi';
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            {notifications.length > 0 && (
              <button
                onClick={clearAll}
                className="px-3 py-2 rounded-lg bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors text-sm"
              >
                Clear All
              </button>
            )}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-shrink-0 flex flex-col items-end gap-2">
                    ...
                    <button
                      ...
                      className="p-1 rounded-md text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors"
                    >
