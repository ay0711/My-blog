  ...
  if (mobile) {
    return (
      <div className="flex flex-col gap-3 w-full pt-2 border-t border-gray-200 dark:border-gray-700">
        ...
        <Link
          href="/settings"
          className="w-full px-4 py-2 text-sm bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition text-center font-medium"
        >
          Settings
        </Link>
        <button
